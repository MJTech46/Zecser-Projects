...
from .views import UserListView, JobSeekerListView, EmployerListView, MyProfileView, CompanyCreateView, CompanyListView, CompanyDetailView, CompanyUpdateView
...
urlpatterns = [
    ...
    path("company/create/", CompanyCreateView.as_view(), name="company-create"),  # create company profile
