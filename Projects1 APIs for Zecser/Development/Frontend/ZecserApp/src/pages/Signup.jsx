...
const Signup = ({ onSignUp, onLogin }) => {
  ...
  return (
    <div className="min-h-screen bg-gray-50 flex items-center justify-center p-4">
      <div className="w-full sm:w-11/12 md:w-3/4 lg:w-2/3 xl:w-1/2 bg-white rounded-3xl shadow-lg overflow-hidden ">
        ...
        <div className="px-6 pb-8">
          ...
          <button
            ...
            disabled={loading}
            className={`w-full py-4 bg-blue-500 text-white font-semibold rounded-full hover:bg-blue-600 transition-colors mb-6 ${
